...
/**
 * Cast id to Entity\Functionality
 *
 * @package Mapper
 * @author Slawomir Nowak (s.nowak@coderdojo.org.pl)
 * @author Michal Tomczak (m.tomczak@coderdojo.org.pl)
 */
class Functionality extends Mapper{
	...
	public function cast($value){
		$entity=$this->getService('doctrine')->getEntityManager()->getRepository('Entity\Functionality')->findOneById($value);
		if(!$entity)
